...
import 'package:mawadda_app/core/components/custom_loader_overlay_component.dart';
import 'package:mawadda_app/core/di/injector.dart';
import 'package:mawadda_app/core/util/global_util.dart';
...
class RegisterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final globalUtil = getIt<GlobalUtil>();
      ...
      child: Scaffold(
        body: BlocListener<RegisterCubit, RegisterState>(
          listener: (context, state) => state.maybeWhen(
            ...
            success: () => context.router.replace(const SucceedRoute()),
            failed: (message) {
              context.loaderOverlay.hide();
              globalUtil.showFailedToast(message);
              return null;
            },
          ),
          child: Container(
